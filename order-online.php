...
<div class="shopping-cart">
        ...
        ?>
        <div class="box">
        <a href="order-online.php?delete_cart_item=<?= $fetch_cart['id']; ?>" class="fas fa-times" onclick="return confirm('delete this cart item?');"></a>
...
<div class="order-now-page">
   ...
   <section class="box-container">
      ...
      <div class="box">
      <h1>takeaway</h1>
      <p>order online and pick up your order at our store.
      </p>
      <div class="del">
      <a href="menu.php" class="btn">TAKEAWAY</a>
      </div>
      </div>
