...
if (isset($_POST['order']) && isset($_POST['method'])) {
   $selectedMethod = $_POST['method'];

   // Initialize the redirect URL
   $redirectURL = '';

   // Check the selected value and set the appropriate redirect URL
   if ($selectedMethod === 'DuitNow QR') {
      $redirectURL = 'payment_QR.php';
   } elseif ($selectedMethod === 'TnG eWallet') {
      $redirectURL = 'payment_tng.php';
   }

   // Perform the redirect if the URL is set
   ...
   <?php
      ...
      <div class="flex">
         ...
         <span>Payment Method</span>
            <select name="method" class="box" id="paymentMethod">
