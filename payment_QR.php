...
<section class="box-container">
   ...
   <div class="box">
    <h1>Duitnow QR Payment</h1>
    <div class='del'>
    <span>Your total is : RM<?= $grand_total; ?></span>
    </div>
    <image src="images/qr.png" width="auto" height="500px">
    <div class='del'>
    <span>Scan the QR code to pay and upload receipts below</span>
   </div>
