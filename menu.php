...
<!-- menu section starts  -->
 <section id="menu-page" class="menu-page">
    ...
    <div class="box-container">
       ...
       <div class="box">
          <a href="pizza.php"><img src="images/pizzaP.jpg" alt=""></a>
          <p>PIZZA</p>
       </div>
 
       <div class="box">
          <a href="fries.php"><img src="images/fries.jpg" alt=""></a>
          <p>FRIES</p>
       </div>
       
       <div class="box">
          <a href="chicken.php"><img src="images/wingsKids.jpg" alt=""></a>
          <p>CHICKEN WINGS</p>
       </div>
       
       <div class="box">
          <a href="rice.php"><img src="images/riceLamb.jpg" alt=""></a>
          <p>RICE</p>
       </div>
       
       <div class="box">
          <a href="pasta.php"><img src="images/pastaWez.jpg" alt=""></a>
          <p>PASTA</p>
       </div>
 
       <div class="box">
          <a href="cheeseBake.php"><img src="images/cheeseBake.jpg" alt=""></a>
          <p>CHEESE BAKED</p>
       </div>
    </div>
    <br>
