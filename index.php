...
if (isset($_POST['back'])) {
   // Add a code to delete all items from the cart for the current user
   $select_cart = $conn->prepare("SELECT * FROM  cart  WHERE user_id = ?");
   $select_cart->execute([$user_id]);
        ...
        <?php
            ...
            if($select_cart->rowCount() > 0){
                while($fetch_cart = $select_cart->fetch(PDO::FETCH_ASSOC)){
                    echo '<p>'.$fetch_cart['name'].' <span>(RM'.$fetch_cart['price'].' x '.$fetch_cart['quantity'].')</span></p>';
                }
            }else{
...
<div class="home-bg" style="background-image: url('<?php echo './images/pizzabg2.jpg'; ?>'); background-size: cover; background-position: center;">
   ...
   <section class="home" id="home">
      ...
      <div class="slide-container">
         ...
         <div class="slide active">
            <div class="image">
               <img src="images/images/wezlay1.png" alt="">
            </div>
            <div class="content">
         ...
         <div class="slide">
            <div class="image">
               <img src="images/images/wezlay2.png" alt="">
            </div>
            <div class="content">
         ...
         <div class="slide">
            <div class="image">
               <img src="images/images/wezlay3.png" alt="">
            </div>
            <div class="content">
               <h3>Thousand Island Pizza</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
               <div class="fas fa-angle-right" onclick="next()"></div>
            </div>
         </div>
...
<section class="about" id="about">
   ...
   <h1 class="heading">SERVING ALL PIZZA LOVERS WITH A TASTE OF HOME</h1>

   <div class="box-container">

      <div class="box">
         <img src="images/htpizza.png" alt="">
         
      </div>

      <div class="box">
         <img src="images/ingred.png" alt="">
         
      </div>

      <div class="box">
         <img src="images/ovenpizza.png" alt="">
...
<section id="menu" class="menu">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <img src="images/wingsKids.jpg" alt="">
         <p>CHICKEN WINGS</p>
      </div>
      
      <div class="box">
         <img src="images/riceLamb.jpg" alt="">
         <p>RICE</p>
      </div>

      <div class="box">
         <img src="images/pastaWez.jpg" alt="">
         <p>PASTA</p>
      </div>

      <div class="box">
         <img src="images/cheeseBake.jpg" alt="">
         <p>CHEESE BAKED</p>
      </div>
      </div>
   </div>
...
<section class="about-us" id="about-us" style="background-image: url('<?php echo './images/pizza4.png'; ?>'); 
   ...
   text-shadow: var(--box-shadow);">Learn More About Wezlay Pizza House</h3>
...
<div class="order-now">
   ...
   <section class="box-container">
      ...
      <div class="box">
      <h1>Ready for the best?</h1>
      <a href="order-online.php" class="btn">ORDER NOW</a>
      </div>
